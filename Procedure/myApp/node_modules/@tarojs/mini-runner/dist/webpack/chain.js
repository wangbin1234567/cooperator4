...
exports.getFileParseLoader = fp_1.pipe(exports.mergeOption, lodash_1.partial(getLoader, path.resolve(__dirname, '../loaders/fileParseLoader')));
...
exports.getModule = (appPath, { sourceDir, designWidth, deviceRatio, buildAdapter, constantsReplaceList, enableSourceMap, cssLoaderOption, lessLoaderOption, sassLoaderOption, stylusLoaderOption, fontUrlLoaderOption, imageUrlLoaderOption, mediaUrlLoaderOption, postcss, compile, babel, alias }) => {
    ...
    //   context: sourceDir
    // }])
    const fileParseLoader = exports.getFileParseLoader([{
            babel,
            alias,
            designWidth,
            deviceRatio,
    ...
    const rule = {
        ...
        media: {
            ...
            use: {
                urlLoader: exports.getUrlLoader([defaultMediaUrlLoaderOption, Object.assign(Object.assign({ name: `${staticDirectory}/media/[name].[ext]` }, mediaUrlLoaderOption), { limit: isQuickapp ? false : mediaUrlLoaderOption.limit })])
            }
        },
        font: {
            test: constants_1.REG_FONT,
            use: {
                urlLoader: exports.getUrlLoader([defaultFontUrlLoaderOption, Object.assign(Object.assign({ name: `${staticDirectory}/fonts/[name].[ext]` }, fontUrlLoaderOption), { limit: isQuickapp ? false : fontUrlLoaderOption.limit })])
            }
        },
        image: {
            test: constants_1.REG_IMAGE,
            use: {
                urlLoader: exports.getUrlLoader([defaultImageUrlLoaderOption, Object.assign(Object.assign({ name: `${staticDirectory}/images/[name].[ext]` }, imageUrlLoaderOption), { limit: isQuickapp ? false : imageUrlLoaderOption.limit })])
            }
        }
    };
    return { rule };
