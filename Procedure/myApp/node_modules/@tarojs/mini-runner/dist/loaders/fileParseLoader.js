...
function processAst({ ast, buildAdapter, type, designWidth, deviceRatio, sourceFilePath, sourceDir, alias }) {
    ...
    babel_traverse_1.default(ast, {
        ...
        ImportDeclaration(astPath) {
            ...
            if (utils_1.isAliasPath(value, alias)) {
                value = utils_1.replaceAliasPath(sourceFilePath, value, alias);
            }
            if (isQuickApp && utils_1.isQuickAppPkg(value)) {
            ...
            if (utils_1.isNpmPkg(value)) {
                ...
                if (!extname || constants_1.REG_SCRIPTS.test(value)) {
                    let vpath = utils_1.resolveScriptPath(path.resolve(sourceFilePath, '..', value));
                    if (fs.existsSync(vpath)) {
                        value = utils_1.promoteRelativePath(path.relative(sourceFilePath, vpath));
