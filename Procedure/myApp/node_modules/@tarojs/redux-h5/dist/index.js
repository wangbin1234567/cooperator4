...
var taroH5 = require('@tarojs/taro-h5');
...
_ref2) {
  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    var selectorFactoryOptions = _objectSpread2({}, connectOptions, {
    ...
    function (_Component) {
      ...
      _proto.addExtraProps = function addExtraProps(props) {
        ...
        var withExtras = _objectSpread2({}, props); // if (withRef) withExtras.ref = this.setWrappedInstance
...
function defaultMergeProps(stateProps, dispatchProps, ownProps) {
  return _objectSpread2({}, ownProps, {}, stateProps, {}, dispatchProps);
}
...
function createConnect(_temp) {
  ...
  return function connect(mapStateToProps, mapDispatchToProps, mergeProps, _ref2) {
    ...
    return connectHOC(selectorFactory, _objectSpread2({
